...
INSERT INTO `product` (`prd_id`, `prd_name`, `prd_image`, `status`,`created`,`user_full`, `prd_details`) VALUES
(1, 'KHÁM PHÁ ĐỘNG THIÊN ĐƯỜNG 1 NGÀY', '1.png', 1, '2023-05-01','Administrator', '- 06:30AM: Xe và hướng dẫn đón quý khách tại khách sạn (nằm trong trung tâm thành phố Huế) và khởi hành đi thăm động thiên đường 1 ngày. <br>
...
(2, 'TOUR VƯỜN QUỐC GIA BẠCH MÃ 1 NGÀY', '2.png', 1, '2023-03-01','Administrator', '- 07:30AM: Xe và hướng dẫn đón quý khách tại khách sạn hoặc điểm hẹn ở Huế (khách sạn nằm trong trung tâm Tp. Huế) và khởi hành đi tham quan Vườn Quốc Gia Bạch Mã. <br>
...
(3, 'TOUR DU LỊCH HOA LƯ - TAM CỐC 1 NGÀY', '5o.png', 1, '2023-03-02', 'Administrator','- 08:00AM: Xe và hướng dẫn viên công ty BKC Travel sẽ đón quý khách tại điểm hẹn hoặc tại khách sạn ở khu vực phố cổ Hà Nội và bắt đầu khởi hành đi Ninh Bình. Sau khoảng 2 tiếng đi xe chúng ta sẽ đến điểm dừng chân đầu tiên tại Hoa Lư kinh đô đầu tiên của nhà nước phong kiến tập quyền Việt Nam. <br>
...
(4, 'TOUR NHA TRANG 1 NGÀY VỊNH NHA PHU - ĐẢO KHỈ', '4.png', 1, '2023-03-03','Administrator', '- 08:30AM: HDV và xe BKC Travel đón khách tại khách sạn ra cầu cảng Đá Chồng. Bắt đầu Tour Nha Trang Vịnh Nha Phu - Đảo Khỉ 1 Ngày. <br>
...
(5, 'TOUR DU LỊCH, KHÁM PHÁ MAI CHÂU 1 NGÀY', '5.png', 1, '2023-03-04','Nhanvien1', '- 07:45AM: Xe đón khách tại Hà Nội, khởi hành đi Mai Châu.
...
'),
(6, 'TOUR BÁI ĐÍNH - TRÀNG AN 1 NGÀY', '6.png', 1, '2023-03-05','Nhanvien1', '- 08:00AM: Xe và Hướng dẫn viên của BKC Travel sẽ đón quý khách tại điểm hẹn khởi hành đi Tour Bái Đính Tràng An .Ninh Bình cách Hà Nội khoảng 100km. Xe sẽ dừng nghỉ ngơi 15 phút tại phủ lý khách hàng tự túc ăn sáng trên đường.Quý khách tiếp tục hành trình tour du lịch Tràng An - Bái Đính ! <br>
...
(7, 'TOUR DU LỊCH HẠ LONG LUXURY 1 NGÀY', '7.png', 1, '2023-03-06','Nhanvien2', '- 07:45AM: Hướng dẫn viên BKC Travel sẽ đón quý khách tại hoặc tại khách sạn trong khu vực phố cổ Hà Nội và khởi hành đi Hạ Long. <br>
...
(8, 'TOUR DU LỊCH ĐẢO YẾN - HÒN NÔI BÃI TẮM ĐÔI 1 NGÀY', '8n.png', 0, '2023-03-07','Nhanvien1', 'Đón khách: Từ 07:00-07:30 Đón khách tại khách sạn đưa đến Cảng Yến Sào Khởi hành đi Đảo Yến - Hòn Nội. Quý khách sẽ dùng điểm tâm sáng nhẹ (bánh mì chả cá + 01 chai nước Sanna 330ml + 01 lon nước Yến) <br>
...
(9, 'TOUR DU LỊCH, THĂM QUAN BÀ NÀ HILL 1 NGÀY', '9m.png', 0, '2023-03-08','Nhanvien2', '- 07:00AM: Hướng dẫn viên cùng xe có mặt đón Quý khách tại điểm hẹn, khởi hành đi Bà Nà theo một trong những cung đường ven biển đẹp nhất Miền Trung. <br>
...
(10, 'TOUR DU LỊCH THÁNH ĐỊA MỸ SƠN - PHỐ CỔ HỘI AN 1 NGÀY', '10.png', 0, '2023-03-09','Nhanvien1', '- 08:00AM: Xe của công ty BKC Travel sẽ đón quý khách tại điểm hẹn lên đường đi đến Thánh địa Mỹ Sơn. <br>
...
(2, 'Nhanvien1', 'nv1@gmail.com', '123456'),
(3, 'Nhanvien2', 'nv2@gmail.com', '123456');
...
ALTER TABLE `user`
  ...
  ADD UNIQUE KEY `user_full` (`user_full`);
