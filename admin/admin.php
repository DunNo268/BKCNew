...
<title>BKC New - Administrator</title>
	...
	<nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
		<div class="container-fluid">
			<div class="navbar-header">
				...
				<a class="navbar-brand" href="#"><span>BKC</span>New</a>
				<ul class="user-menu">
	...
	<div id="sidebar-collapse" class="col-sm-3 col-lg-2 sidebar">
		<ul class="nav menu">
			...
			<?php if (checkPrivilege('index.php?page=product')) { ?>
			    <li><a href="index.php?page=product"><svg class="glyph stroked bag"><use xlink:href="#stroked-bag"></use></svg>Quản lý tin tức du lịch</a></li>
			<?php } ?>
			<?php if (checkPrivilege('index.php?page=order')) { ?>
			    <li><a href="index.php?page=order"><svg class="glyph stroked bag"><use xlink:href="#stroked-bag"></use></svg>Duyệt bài viết</a></li>
			<?php } ?>
		</ul>
	</div>
	<!--/.sidebar-->
	...
	if(isset($_GET['page'])) {
		switch ($_GET['page']) {
			...
			case 'edit_product':
				...
				break;
			case 'edit_status':
				require_once "modules/product/edit_status.php";
				break;
			case 'see_product':
				require_once "modules/product/see_product.php";
			break;
			// user module
			case 'user':
