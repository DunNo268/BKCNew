                    ...
                    <div class="panel-body">
                        <div class="col-md-6">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="user_full" required class="form-control" value="<?php echo $prodEdit['user_full'];  ?>"  placeholder="">
                            </div> 
                            <div class="form-group">
                                <label>Ngày viết</label>
                                <input required name="created" class="form-control" value="<?php echo $prodEdit['created'];  ?>" placeholder="">
                            </div>                
                        </div>
                        <div class="col-md-6">
                            <div class="form-group">
