...
<div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2 main">			
    <div class="row">
        <ol class="breadcrumb">
            ...
            <li class="active">Danh sách tin tức du lịch</li>
        </ol>
    </div><!--/.row-->
    
    <div class="row">
        <div class="col-lg-12">
            <h1 class="page-header">Danh sách tin tức du lịch</h1>
        </div>
    </div><!--/.row-->
    ...
    <?php if (checkPrivilege('index.php?page=add_product')) { ?>
        <div id="toolbar" class="btn-group">      
            <a href="index.php?page=add_product" class="btn btn-success">
                <i class="glyphicon glyphicon-plus"></i> Thêm tin tức du lịch
            </a>
        </div>
    <?php } ?>
    <div class="row">
                                ...
                                <tr>
                                    ...
                                    <td class="form-group">
                                        ...
                                        <?php if (checkPrivilege('index.php?page=edit_product&prd_id='.$row['prd_id'])) { ?>
                                            <a href="index.php?page=edit_product&prd_id=<?php echo $row['prd_id']; ?>" class="btn btn-primary">
                                                <i class="glyphicon glyphicon-pencil"></i>
                                            </a>
                                        <?php } ?>
                                            <a onclick="return confirmDel();" href="modules/product/del_product.php?prd_id=<?php echo $row['prd_id']; ?>" class="btn btn-danger">
